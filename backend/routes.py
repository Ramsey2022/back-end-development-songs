...
def create_song():
    ...
    insert_song = db.songs.insert_one(new_song)
    return {'inserted id': parse_json(insert_song.inserted_id)}, 201
...
def update_song(id):
    ...
    if song:
        ...
        result = db.songs.update_one(song, updated_song)
